...
public class tableclass {
    ...
    public static void main(String[] args) {
        try {
            String StudentDetails = "create table Users(AdmissionNo char(100),FirstName char(100),LastName varchar(100),MiddleName char(100),Gender varchar(100),Phone varchar(100),Email varchar(100),Status varchar(100),UNIQUE(Email))";
            databaseoperation.setDataorDelete(StudentDetails, "User Table Created Successfully");
